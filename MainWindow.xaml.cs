...
namespace Trend
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void Chart_Ini()
        {
            ...
            trend_scatter_3 = wpfPlot_Trend.Plot.AddScatter(trend_dt, trend_data3, color: System.Drawing.Color.Green,  label: "ch3");
            trend_scatter_4 = wpfPlot_Trend.Plot.AddScatter(trend_dt, trend_data4, color: System.Drawing.Color.SkyBlue, label: "ch4");
        ...
        private void History_CH_N_Show(object sender, RoutedEventArgs e)
        {
            ...
            else if (checkBox.Name == "Histry_Ch3_CheckBox")
            {
        ...
        //     rcvBuf[7] :  : のHighバイト   
        //     rcvBuf[8] : ch3 のLowバイト   (10倍した値 例:300ならば30.0℃を表す)
        //     rcvBuf[9] :  :  のHighバイト   
        //     rcvBuf[10] : ch4 のLowバイト   (10倍した値 例:300ならば30.0℃を表す)
        //     rcvBuf[11] :  :  のHighバイト 
        ...
        private void Disp_monitor_data()
        {
            ...
            ch3 = (float)(dt / 10.0);
            Ch3_TextBox.Text = ch3.ToString("F1");   // ch3

            dt = BitConverter.ToInt16(rcvBuf, 10);    // rcvBuf[10]から int16へ
            ch4 = (float)(dt / 10.0);
            Ch4_TextBox.Text = ch4.ToString("F1");   // ch4
            ...
            dt = BitConverter.ToInt16(rcvBuf, 30);    // rcvBuf[30]から int16へ (Kg)
            if (dt == 0)
            {
                Kg_TextBox.Text = "---";
            }
            ...
            {
                Kg_TextBox.Text = dt.ToString();         // Kg(=100/P)表示
            }
        ...
        private void MV_Write_Button_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                sendBuf[4] = byteArray[0];      //  単精度浮動小数点型データ 4byte
                sendBuf[5] = byteArray[1];
                sendBuf[6] = byteArray[2];
                sendBuf[7] = byteArray[3];
        ...
        private void Save_Button_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (sfd.ShowDialog() == true)            //ダイアログを表示する
            {
                ...
                try
                {
                    ...
                    str_one_line = "DateTime" + "," + "PV(ch1)" + "," + "SV" + "," + "MV" + "," + "ch2" + "," + "ch3" + "," + "ch4" + "," 
        ...
        private void disp_history_graph()
        {
            ...
            history_scatter_3 = wpfPlot_History.Plot.AddScatter(t_dt, t_data3, color: System.Drawing.Color.Green, label: "ch3");
            history_scatter_4 = wpfPlot_History.Plot.AddScatter(t_dt, t_data4, color: System.Drawing.Color.SkyBlue, label: "ch4");
